...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = __webpack_require__(407);
	var AHMIDesigner = __webpack_require__(433);
	ReactDOM.render(React.createElement(AHMIDesigner, null), document.getElementById('editor'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".designer-main-body{\n\toverflow: hidden;\n}\n\n.toolbox-wrapper{\n\tmargin: 0;\n\tborder:1px solid gray;\n\twidth:15%;\n\ttext-align: center;\n\tfloat: left;\n\n}\n.toolbox-button{\n\tmargin:1px;\n\twidth:100%;\n}\n\n/*editor*/\n.editor-frame{\n\tmargin: 0 auto;\n\tmin-width: 50%;\n\tmax-width: 68%;\n\tfloat:left;\n}\n\n\n.attr-list {\n\tmargin:0;\n\twidth: 15%;\n\ttext-align: left;\n\tborder: 1px solid gray;\n\tfloat: right;\n}\n\n.attr-line{\n\tmargin: 1px;\n\twidth:100%;\n\ttext-align: left;\n}\n\n.attr-title{\n\tmargin-left: 1em;\n}\n\n.attr-name{\n\tmargin-left: 1em;\n\tdisplay: inline-block;\n\twidth:30%;\n}\n.attr-line>input{\n\twidth:60%;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Actions = __webpack_require__(408);
	var setTargetStore = __webpack_require__(428);
	var addElementStore = __webpack_require__(429);
	var changeAttrStore = __webpack_require__(430);
	var ToolBox = __webpack_require__(431);
	var ReactDOM = __webpack_require__(158);
	module.exports = React.createClass({
		...
		inBoundingRect: function (curCoords, widget, type) {
			...
			if (type == 'widget') {
				if (widget.type == 'button') {
					...
					if (Math.pow(curCoords.x - widget.x, 2) + Math.pow(curCoords.y - widget.y, 2) < Math.pow(widget.r, 2)) {
						return true;
					};
				}
			} else if (type == 'canvas') {
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'editor-mainpanel', ref: 'mainpanel', style: { width: '100%', overflow: 'scroll' } },
					React.createElement(
						'div',
						{ ref: 'canvaswrap', onMouseDown: this.handleMouseDown, onMouseMove: this.handleMouseMove, onMouseUp: this.handleMouseUp, onClick: this.handleMouseClick },
						React.createElement('canvas', { className: 'canvas', ref: 'canvas' })
					),
					React.createElement(
						'div',
						null,
						React.createElement('canvas', { className: 'offCanvas', ref: 'offCanvas', style: { display: 'none' } })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(409);
	var Actions = Reflux.createActions(["addElement", "changeAttr", "setTarget"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(410);

	Reflux.connect = __webpack_require__(423);

	Reflux.connectFilter = __webpack_require__(425);

	Reflux.ListenerMixin = __webpack_require__(424);

	Reflux.listenTo = __webpack_require__(426);

	Reflux.listenToMany = __webpack_require__(427);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(411);

	Reflux.ListenerMethods = __webpack_require__(412);

	Reflux.PublisherMethods = __webpack_require__(421);

	Reflux.StoreMethods = __webpack_require__(420);

	Reflux.createAction = __webpack_require__(422);

	Reflux.createStore = __webpack_require__(416);

	var maker = __webpack_require__(415).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(413);
	...
	Reflux.__keep = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(413),
	    maker = __webpack_require__(415).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(414);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(416),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(413),
	    Keep = __webpack_require__(417),
	    mixer = __webpack_require__(418),
	    bindMethods = __webpack_require__(419);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(420),
	        PublisherMethods = __webpack_require__(421),
	        ListenerMethods = __webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(413),
	    ActionMethods = __webpack_require__(411),
	    PublisherMethods = __webpack_require__(421),
	    Keep = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(412),
	    ListenerMixin = __webpack_require__(424),
	    _ = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AddWidgetButton = __webpack_require__(432);
	module.exports = React.createClass({
		displayName: 'exports',
		...
		render: function () {
			...
			return React.createElement(
				...
				'Tool Box',
				React.createElement(AddWidgetButton, { name: 'Canvas', element: { type: 'canvas', content: defaultCanvas } }),
				React.createElement(AddWidgetButton, { name: 'Widget', element: { type: 'widget', content: defaultWidget } })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		handleClick: function (e) {
			e.preventDefault();
			Actions.addElement(this.props.element);
		},
		render: function () {
			return React.createElement(
				'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolBox = __webpack_require__(431);
	var Editor = __webpack_require__(407);
	var AttributeList = __webpack_require__(434);
	module.exports = React.createClass({
		displayName: 'exports',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		render: function () {
			...
			var attrlineList = [];
			for (keyl in obj) {
				attrlineList.push(React.createElement(AttrLine, { key: keyl, name: keyl, value: obj[keyl], valueType: typeof obj[keyl], handleChange: this.handleChange, handleFocusOut: this.handleFocusOut, handleKeyPress: this.handleKeyPress }));
			}
			return React.createElement(
				'div',
				{ className: 'attr-list' },
	...
	var AttrLine = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement('input', { value: this.props.value, onChange: this.handleChange, onBlur: this.handleFocusOut, onKeyDown: this.handleKeyPress })
			);
		}
	});
