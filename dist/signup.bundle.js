...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Validator = __webpack_require__(436);
	var ERRORS = {
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { name: 'firstName', type: 'text', placeholder: 'First Name', value: this.state.userInfo.firstName, onChange: this.handleChange }),
					React.createElement('input', { name: 'lastName', type: 'text', placeholder: 'Last Name', value: this.state.userInfo.lastName, onChange: this.handleChange })
				),
				React.createElement(
					'div',
					{ className: 'field formerror' },
				...
				React.createElement(
					...
					React.createElement('input', { name: 'mail', type: 'text', placeholder: 'Mail', value: this.state.userInfo.mail, onChange: this.handleChange })
				),
				React.createElement(
					'div',
					{ className: 'field formerror' },
				...
				React.createElement(
					...
					React.createElement('input', { name: 'password', type: 'password', placeholder: 'Passowrd', value: this.state.userInfo.password, onChange: this.handleChange })
				),
				React.createElement(
					'div',
					{ className: 'field formerror' },
				...
				React.createElement(
					...
					React.createElement('input', { name: 'confirmPassword', type: 'password', placeholder: 'Reinput Passowrd', value: this.state.userInfo.confirmPassword, onChange: this.handleChange })
				),
				React.createElement(
					'div',
					{ className: 'field formerror' },
				...
				React.createElement(
					...
					React.createElement('input', { type: 'submit', value: 'Sigup' })
				)
			);
		}
	});
